      ...
      methodHttp(solicitud).subscribe(
        data => {
          if(data) {
            $("#modal").modal('hide');
            tipoOperacion === 'alta'
              ? this._fx.showAlert("Solicitud enviada", "La solicitud se efectuó correctamente, consultá el estado de la misma en las próximas 24 a 48 hs. Recordá consultar el estado de tu trámite en la página principal, opción 'Consultar solicitud'.", "success", 500)
              : this._fx.showAlert("Solicitud editada", "La solicitud se editó correctamente, consultá el estado de la misma en las próximas 24 a 48 hs. Recordá consultar el estado de tu trámite en la página principal, opción 'Consultar solicitud'.", "success", 500);
