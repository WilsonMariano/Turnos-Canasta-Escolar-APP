      ...
      methodHttp(solicitud).subscribe(
        data => {
          if(data) {
            $("#modal").modal('hide');
            tipoOperacion === 'alta'
              ? this._fx.showAlert("Solicitud enviada", "La solicitud se efectuó correctamente, en un lapso de 48 hs. la misma será validada. Recordá consultar el estado de tu trámite en la página principal, opción 'Consultar solicitud'.", "success", 500)
              : this._fx.showAlert("Solicitud editada", "La solicitud se editó correctamente, en un lapso de 48 hs. la misma será validada. Recordá consultar el estado de tu trámite en la página principal, opción 'Consultar solicitud'.", "success", 500);
